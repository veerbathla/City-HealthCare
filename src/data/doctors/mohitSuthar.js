...
import mohit from "../../assets/doctors/mohit.png";
...
const mohitSuthar = {
  ...
  designation: "Consultant Pathologist",
  department: "Pathology",
  speciality: "Histopathology & Clinical Pathology",

  qualifications: [
    "MBBS",
    "MD (Pathology)",
    "PDCC Gastro Pathology",
  ],
  ...
  expertise: [
    {
      title: "Histopathology",
      description:
        "Microscopic examination of tissues for accurate disease diagnosis.",
    },
    {
      title: "Clinical Pathology",
      description:
        "Comprehensive laboratory evaluation of blood, urine, stool, and body fluids.",
    },
    {
      title: "Cytopathology",
      description:
        "FNAC and Pap Smear evaluation for early disease detection.",
    },
    {
      title: "Microbiology",
      description:
        "Culture, sensitivity testing, and infectious disease diagnosis.",
    },
    {
      title: "Laboratory Medicine",
      description:
        "High-quality diagnostic services using modern automated laboratory systems.",
    },
  ],
  ...
  seo: {
    ...
    description:
      "Consultant Pathologist at City HealthCare Neuro Research and Infertility Centre, Sirsa. Expert in Histopathology, Clinical Pathology, FNAC, Biopsy Analysis and Laboratory Diagnostics.",
    keywords: [
      "Pathologist Sirsa",
      "Clinical Pathology",
      "Histopathology",
