...
const abhishekSingh = {
  ...
  education: [
    ...
    {
      degree: "MBBS",
      institute: "NRS Medical College, Kolkata",
    },
  ],
  ...
  highlights: [
    ...
    "Performed Haryana's Awake Craniotomy for Brain Tumour Patient",
    "Advanced Minimally Invasive Spine Surgeon",
  ...
  seo: {
    ...
    description:
      "Consultant Neurosurgeon & Director at City HealthCare Neuro Research and Infertility Centre, Sirsa. Expert in Endoscopic Spine Surgery, Brain Tumour Surgery & Awake Craniotomy.",
    keywords: [
      "Neurosurgeon Sirsa",
      "Brain Surgeon Haryana",
