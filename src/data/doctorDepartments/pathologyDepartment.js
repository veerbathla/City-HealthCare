...
export const pathologyDepartment = {
  ...
  shortDescription:
    "Comprehensive laboratory diagnostic services delivering accurate, reliable, and timely test results for precise diagnosis and better patient care.",

  image: pathology,

  seo: {
    title: "Pathology | City HealthCare",
    description:
      "Advanced pathology and laboratory diagnostic services at City HealthCare, Sirsa.",
  },
};