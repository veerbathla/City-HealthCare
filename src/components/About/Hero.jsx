        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-24">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 mt-10 max-w-4xl">
            ...
            <div className="bg-white/10 backdrop-blur-md border border-white/10 rounded-xl p-5">
              ...
              <h3 className="text-white font-semibold text-lg">
                {t("aboutHero.feature1Title")}
              </h3>

              <p className="text-blue-100 mt-2 text-sm">
                {t("aboutHero.feature1Desc")}
              </p>
            ...
            <div className="bg-white/10 backdrop-blur-md border border-white/10 rounded-xl p-5">
              ...
              <h3 className="text-white font-semibold text-lg">
                {t("aboutHero.feature2Title")}
              </h3>

              <p className="text-blue-100 mt-2 text-sm">
                {t("aboutHero.feature2Desc")}
              </p>
            ...
            <div className="bg-white/10 backdrop-blur-md border border-white/10 rounded-xl p-5">
              ...
              <h3 className="text-white font-semibold text-lg">
                {t("aboutHero.feature3Title")}
              </h3>

              <p className="text-blue-100 mt-2 text-sm">
                {t("aboutHero.feature3Desc")}
              </p>
