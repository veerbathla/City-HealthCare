            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div>
                ...
                <h2 className="text-4xl lg:text-6xl font-bold text-white mt-8 leading-tight">
                  ...
                  <span className="text-cyan-300"> Health Starts Here</span>
                </h2>

                <p className="mt-8 text-blue-100 text-lg leading-8">
                  Whether you need expert consultation, emergency care, advanced
                  diagnostics, or specialized treatment, City HealthCare is
                  committed to providing compassionate, comprehensive healthcare
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="bg-white rounded-3xl p-8 text-center shadow-xl">
                  ...
                  <p className="text-gray-600 mt-2">Medical Consultation</p>
                </div>
                ...
                <div className="bg-white rounded-3xl p-8 text-center shadow-xl">
                  ...
                  <p className="text-gray-600 mt-2">Complete Healthcare</p>
                </div>
              </div>
            </div>
          </div>
